...
controller1612_error::controller1612_error(const string &s) :
	traceable_error(s)
{
}
...
controller1612_driver::~controller1612_driver()
{
}
...
void controller1612_driver::cmd_discover_1wire(uint8_t pin)
{
	uint8_t id[8];
	...
	try
	{
		while (1)
		{
			...
			switch (id[0])
			{
				case 0x28 : cout << "DS1820 temperature sensor:   "; break;
...
void controller1612_driver::cmd_show_ram_usage()
{
	uint8_t hi, lo;
...
void controller1612_driver::cmd_config_reload()
{
